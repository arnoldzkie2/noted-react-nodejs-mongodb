...
const Header = () => {
  ...
  const { setCreateNotes, setTheme, theme, searchNote, setSearchNote } = useGlobalContext();
  ...
  const darkMode = () => {
    if(theme === 'light') {
      ...
      document.documentElement.style.setProperty('--second1', 'rgb(245,245,245)');
  ...
  const createNewNote = () => {
    ...
    setCreateNotes(true) // Set 'createNotes' to true to show create note section
  }
